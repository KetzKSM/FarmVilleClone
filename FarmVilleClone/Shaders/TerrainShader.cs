...
namespace FarmVilleClone.Shaders
{
    ...
    {
        private static readonly string VertexFile = "./../../Shaders/TerrainVertexShader.glsl";
        private static readonly string FragmentFile = "./../../Shaders/TerrainFragmentShader.glsl";
